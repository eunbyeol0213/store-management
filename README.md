...
## 8. 주요 기능
### 로그인 기능
- 사용자들에게 아이디는 담당자 코드로 비밀번호는 휴대전화 뒷자리 4자리로 로그인 기능을 제공합니다. 
- 로그인 후 비밀번호 변경이 가능합니다
### CRUD 기능
- 담당자/센터/센터 점수/센터 사진에 관해 조건 별로 검색이 가능하고, 등록, 수정이 가능
### 맵핑 기능
- 담당자 명을 검색해 맵핑 할 담당자를 선택하면 담당하고 있는 센터 리스트가 보여집니다.
- 그 다음 맵핑을 하거나 맵핑 해제가 가능합니다.
### 통계 기능
- 사용자가 시스템, 담당자, 센터 관리자로 나뉩니다. 
- 사용자의 권한에 따라 센터별, 담당자별 등으로 통계가 나타납니다.
